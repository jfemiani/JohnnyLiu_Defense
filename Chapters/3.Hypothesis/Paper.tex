...
The main steps of our approach are illustrated in \figref{fig:Apparatus};
...
Note that warping the input image to form the ribbon image does not necessarily need to be done; 
...
dimension represent the thickness of the ribbon as illustrated in \figref{fig:ribbon_3d}. Every
